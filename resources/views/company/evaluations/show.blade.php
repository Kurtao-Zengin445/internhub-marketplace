...
<div class="col-xl-4 d-flex flex-column gap-3">
    ...
    <div class="card">
        <div class="card-header"><i class="bi bi-arrow-left-right text-secondary me-2"></i>Nilai Supervisor</div>
        <div class="card-body text-center" style="padding:20px">
            ...
            @else
                <div style="font-size:13px;color:#94a3b8">Belum dinilai oleh supervisor</div>
            @endif
        </div>
    </div>
    ...
    <div class="card" style="border-color:#bfdbfe;background:#eff6ff">
        <div class="card-body text-center" style="padding:20px">
            ...
            <div style="font-size:12px;color:#3b82f6;margin-top:4px">40% Supervisor + 60% Perusahaan</div>
        </div>
    </div>
    @endif
</div>
